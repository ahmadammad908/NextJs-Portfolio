...
export const ContactSection = () => {
  return <div className="py-16 pt-14 lg:py-24 lg:pt-20 ">
    <div className="container">
      <div className="bg-gradient-to-r from-emerald-300 to-sky-400 text-gray-900 py-8 px-10 rounded-3xl text-center md:text-left relative overflow-hidden ">
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-16  items-center">
          <div>
            <h2 className="font-serif text-2xl md:text-3xl font-bold">&rsquo;Let's create something amazing together</h2>
          ...
          <div>
            ...
            border border-gray-900 z-20">
                <span className="font-semibold z-50">Contact Me</span>
